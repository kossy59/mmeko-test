            ...
            <div id={`PostMainLikes-${post?.id}`} className="relative mr-[75px]">
                <div className="absolute bottom-0 pl-2">
                    <div className="pb-4 text-center">
                        ...
                        <span className="text-xs text-zinc font-semibold">
                            {likes?.length}
                        </span>
                    </div>
                    ...
                    >
                        ...
                        <span className="text-xs text-zinc font-semibold">{comments?.length}</span>
                    </button>
                    ...
                    <button className="text-center">
                        ...
                        <span className="text-xs text-zinc font-semibold">0</span>
                    </button>
                </div>
            </div>
        </>
