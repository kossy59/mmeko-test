...
export default function Comments({ params }: CommentsCompTypes) {
    ...
    return (
        <>
            <div 
                id="Comments" 
                className="relative bg-dark-1 z-0 w-full h-[calc(100%-273px)] border-t-2 border-t-dark-4 overflow-auto"
            >
            ...
            <div 
                id="CreateComment" 
                className="absolute flex items-center justify-between bottom-0  h-[85px] lg:max-w-[550px] w-full py-5 px-8 border-t-2 border-t-dark-4"
            >
                <div 
                    className={`
                        bg-[#F1F1F2] flex items-center rounded-lg w-full lg:max-w-[420px]
                        ${inputFocused ? 'border-2 border-dark-4' : 'border-2 border-dark-4'}
                    `}
                >
                    <input 
                        ...
                        value={comment || ''}
                        className="bg-dark-5 text-[14px] text-zinc focus:outline-none w-full lg:max-w-[420px] p-2 rounded-lg" 
                        type="text"
