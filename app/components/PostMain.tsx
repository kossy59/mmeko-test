...
export default function PostMain({ post }: PostMainCompTypes) {
    ...
    return (
        <>
            <div id={`PostMain-${post.id}`} className="flex border-b border-b-dark-4 py-6">
                ...
                <div className="pl-3 w-full px-4">
                    <div className="flex items-center justify-between pb-0.5">
                        ...
                        <button className="border border-light-orange text-[15px] px-[21px] py-0.5 text-light-orange hover:bg-red-1 font-semibold rounded-md">
                            Follow
                        </button>
                    </div>
