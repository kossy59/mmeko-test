        ...
        <>
            ...
            >
                <div className="lg:w-[calc(100%-540px)] h-full relative">
                    <Link
                        href={'/'}
                        className="absolute text-gray-400 z-20 m-5 rounded-full bg-gray-700 p-1.5 hover:bg-gray-800"
                    >
                    ...
                    <div >
                        ...
                        >
                            <BiChevronUp size="30" className="text-gray-400"/>
                        </button>
                        ...
                        >
                            <BiChevronDown size="30"  className="text-gray-400"/>
                        </button>
                    </div>
                ...
                <div id="InfoSection" className="lg:max-w-[550px] relative w-full h-full bg-dark-1">
                    <div className="py-7" />
