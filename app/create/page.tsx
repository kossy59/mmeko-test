...
export default function Create() {
    ...
    return (
        <>
            <UploadLayout>
                <div className="w-full mt-[80px] mb-[40px] bg-dark-4 shadow-lg rounded-md py-6 md:px-10 px-4">
                    <div>
                        <h1 className="text-[23px] text-light-orange font-semibold">Upload video</h1>
                    ...
                    <div className="mt-8 md:flex gap-6">
                        ...
                        {!fileDisplay ? 
                            ...
                            >
                                ...
                                <p className="mt-4 text-gray-400 text-[17px]">Select video to upload</p>
                                ...
                                <label 
                                    htmlFor="fileInput" 
                                    className="px-2 py-1.5 mt-8 text-zinc text-[15px] w-[80%] bg-red-1 rounded-sm cursor-pointer"
                                >
                                    Select file
                                </label>
                                <input 
                            ...
                            >
                                {isUploading ? (
                                    <div className="absolute flex items-center justify-center z-20 bg-black h-full w-full rounded-[50px] bg-opacity-50">
                                        <div className="mx-auto flex items-center justify-center gap-1">
                                            <BiLoaderCircle className="animate-spin" color="#F02C56" size={30} />
                                            <div className="text-zinc font-bold">Uploading...</div>
                                        </div>
                                    </div>
                                ) : null}
                                ...
                                <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
                                    <div className="flex items-center truncate">
                                        <AiOutlineCheckCircle size="16" className="min-w-[16px] text-gray-500"/>
                                        <p className="text-[11px] pl-1 text-gray-500 truncate text-ellipsis">{File.name}</p>
                                    </div>
                                    <button onClick={() => clearVideo()} className="text-[11px] ml-2 font-semibold text-gray-500">
                                        Change
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-dark-5 py-4 px-6">
                                <div>
                                    <PiKnifeLight className="mr-4" size="20"/>
                                </div>
                                <div>
                                    <div className="text-semibold text-light-orange text-[15px] mb-1.5">Divide videos and edit</div>
                                ...
                                <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                                    <button className="px-8 py-1.5 text-zinc text-[15px] bg-red-1 rounded-sm">
                                        Edit
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex items-center justify-between">
                                    <div className="mb-1 text-light-orange text-[15px]">Caption</div>
                            ...
                            <div className="flex gap-3">
                                <button 
                                    ...
                                    onClick={() => discard()}
                                    className="px-10 py-2.5 mt-8 text-zinc border border-gray-400 text-[16px] hover:bg-dark-5 rounded-sm"
                                >
                                    Discard
                                </button>
                                <button 
                                    ...
                                    className="px-10 py-2.5 mt-8 border border-gray-400 text-[16px] text-zinc bg-red-1 rounded-sm"
                                >
                                    {isUploading ? <BiLoaderCircle className="animate-spin" color="#BAC4C8" size={25} /> : 'Post'}
                                </button>
                            </div>
